            ...
            <div className={styles.hallPayment}>
                <motion.div
                    ...
                    <div className={styles.card_content}>
                        ...
                        >Зал рассчитан на 2-4 гостя. Идеальный вариант для кино-свидания в приватной обстановке.
                            Два мягких дивана канапе и пуфы.
                        </motion.p>
                        <ul className={styles.card_hall}>
                            {cards.map((el, i) => (
                                <motion.li
                                    ...
                                    className={i === activeIndex ? `${styles.card_hall__item} ${styles.active}` : styles.card_hall__item}>
                    ...
                    <div className={styles.form}>
                        ...
                        <div className={styles.form_item}>
                            <select name="bookingtime" className="bookingtime bookingform-input" required="">
                                <option disabled="true" value="00:00">00:00</option>
                                <option disabled="true" value="01:00">01:00</option>
                                <option disabled="true" value="02:00">02:00</option>
                                <option disabled="true" value="03:00">03:00</option>
                                <option disabled="true" value="04:00">04:00</option>
                        ...
                        <div className={styles.form_item}>
                            <div className={styles.form__title}>Введите ваш номер телефона:</div>
                    ...
                    <div className={styles.card__close} onClick={() => dispatch(getHall(false))}>
